...
<div class="container">
    ...
    <h2 style="text-align:center; margin-top:20px">Make a Deposit - Total R{{$depositprice}}</h2>
                ...
                <div class="panel-body">
                    ...
                    @if (Session::has('success'))
                        <div class="alert alert-success text-center">
                            <a href="{{url('thank_you')}}" class="close" data-dismiss="alert" aria-label="close">×</a>
                    ...
                    <form 
                            role="form" 
                            action="{{ route('stripe.post_dep', $depositprice) }}" 
                            method="post" 
